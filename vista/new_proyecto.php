...
<head>
    ...
    <title>Registrar Proyecto Integrador</title>
...
<body>
    ...
    <!-- Contenido principal -->
    <div class="container">
        <h1>Registrar Nuevo Proyecto Integrador</h1>
        <div class="form-container">
            <form action="../controlador/ctrl_new_proyecto.php" method="POST">
                <label for="codigo_sis">Código SIS:</label>
                <input type="text" name="codigo_sis" required>
                ...
                <input type="text" name="area_enfoque">
                ...
                <input type="text" name="documento_proyecto">
